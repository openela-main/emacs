...
echo %{emacs_libexecdir}/${pgtk_pdmp} >> pgtk-filelist
echo %{emacs_libexecdir}/${gtkx11_pdmp} >> gtk+x11-filelist
echo %{emacs_libexecdir}/${lucid_pdmp} >> lucid-filelist
echo %{emacs_libexecdir}/${nw_pdmp} >> nw-filelist
...
%files gtk+x11 -f gtk+x11-filelist
...
* Thu Nov 14 2024 Jacek Migacz <jmigacz@redhat.com> - 1:29.4-9
- Add libtree-sitter as runtime dependency

* Wed Nov 13 2024 Jacek Migacz <jmigacz@redhat.com> - 1:29.4-8
- Bump release

* Tue Oct 29 2024 Troy Dawson <tdawson@redhat.com> - 1:29.4-7
- Bump release for October 2024 mass rebuild:

* Wed Sep 18 2024 Lukáš Zaoral <lzaoral@redhat.com> - 1:29.4-6
- tests: fix filter to include missing gating tests

* Wed Sep 18 2024 Lukáš Zaoral <lzaoral@redhat.com> - 1:29.4-5
- tests: fix URL to internal tests repo

* Thu Aug 22 2024 Jacek Migacz <jmigacz@redhat.com> - 1:29.4-4
- Unset custom linker flags

* Thu Aug 22 2024 Jacek Migacz <jmigacz@redhat.com> - 1:29.4-3
- Improve the security of the generated code by hardening

* Wed Aug 21 2024 Jacek Migacz <jmigacz@redhat.com> - 1:29.4-2
- Disable Native-Compilation feature

* Wed Aug 07 2024 Jacek Migacz <jmigacz@redhat.com> - 1:29.4-1
- Rebase to version 29.4

* Tue Aug 06 2024 Frantisek Sumsal <fsumsal@redhat.com> - 1:29.2-7
- Add gating configuration for C10S/RHEL10

* Mon Jun 24 2024 Troy Dawson <tdawson@redhat.com> - 1:29.2-6
- Bump release for June 2024 mass rebuild

* Mon Apr 29 2024 Pavol Žáčik <pzacik@redhat.com> - 1:29.2-5
...
* Wed Jan 17 2024 Tim Landscheidt <tim@tim-landscheidt.de> - 1:29.1-16
